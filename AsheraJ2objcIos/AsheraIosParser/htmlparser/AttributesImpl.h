...
#ifndef _OrgCcilCowanTagsoupAttributesImpl_H_
#define _OrgCcilCowanTagsoupAttributesImpl_H_
...
/**
 ...
 <blockquote> <em>This module, both source code and documentation, is in the Public Domain, and comes with <strong>NO WARRANTY</strong>.</em> See <a href='http://www.saxproject.org'>http://www.saxproject.org</a> for further information. </blockquote> <p>This class provides a default implementation of the SAX2 org.xml.sax.Attributes Attributes interface, with the addition of manipulators so that the list can be modified or reused.</p> <p>There are two typical uses of this class:</p> <ol> <li>to take a persistent snapshot of an Attributes object in a org.xml.sax.ContentHandler#startElement startElement event; or</li> <li>to construct or modify an Attributes object in a SAX2 driver or filter.</li> </ol> <p>This class replaces the now-deprecated SAX1 org.xml.sax.helpers.AttributeListImpl AttributeListImpl class; in addition to supporting the updated Attributes interface rather than the deprecated org.xml.sax.AttributeList AttributeList interface, it also includes a much more efficient implementation using a single array rather than a set of Vectors.</p>
 @since SAX 2.0
 @author David Megginson
 @version 2.0.1 (sax2r2)
 */
@interface OrgCcilCowanTagsoupAttributesImpl : NSObject < OrgXmlSaxAttributes > {
 @public
  jint length_;
...
/**
 ...
 <p>This constructor is especially useful inside a org.xml.sax.ContentHandler#startElement startElement event.</p>
...
/**
 ...
 <p>For the sake of speed, this method does no checking to see if the attribute is already in the list: that is the responsibility of the application.</p>
...
/**
 ...
 <p>Note that little memory is freed by this call: the current array is kept so it can be reused.</p>
 */
- (void)clear;
...
/**
 ...
 <p>In many cases, it will be more efficient to look up the name once and use the index query methods rather than using the name query methods repeatedly.</p>
...
/**
 ...
 <p>For the sake of speed, this method does no checking for name conflicts or well-formedness: such checks are the responsibility of the application.</p>
 @param index The index of the attribute (zero-based).
 @param uri The Namespace URI, or the empty string if none is available or Namespace processing is not being performed.
 @param localName The local name, or the empty string if Namespace processing is not being performed.
...
/**
 ...
 <p>It may be more efficient to reuse an existing object rather than constantly allocating new ones.</p>
...
J2OBJC_EMPTY_STATIC_INIT(OrgCcilCowanTagsoupAttributesImpl)

J2OBJC_FIELD_SETTER(OrgCcilCowanTagsoupAttributesImpl, data_, IOSObjectArray *)

FOUNDATION_EXPORT void OrgCcilCowanTagsoupAttributesImpl_init(OrgCcilCowanTagsoupAttributesImpl *self);

FOUNDATION_EXPORT OrgCcilCowanTagsoupAttributesImpl *new_OrgCcilCowanTagsoupAttributesImpl_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT void OrgCcilCowanTagsoupAttributesImpl_initWithOrgXmlSaxAttributes_(OrgCcilCowanTagsoupAttributesImpl *self, id<OrgXmlSaxAttributes> atts);

FOUNDATION_EXPORT OrgCcilCowanTagsoupAttributesImpl *new_OrgCcilCowanTagsoupAttributesImpl_initWithOrgXmlSaxAttributes_(id<OrgXmlSaxAttributes> atts) NS_RETURNS_RETAINED;

J2OBJC_TYPE_LITERAL_HEADER(OrgCcilCowanTagsoupAttributesImpl)

#endif // _OrgCcilCowanTagsoupAttributesImpl_H_
