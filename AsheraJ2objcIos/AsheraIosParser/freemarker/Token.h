...
#ifndef _FreemarkerCoreToken_H_
#define _FreemarkerCoreToken_H_
 ...
 */
@interface FreemarkerCoreToken : NSObject < JavaIoSerializable > {
 @public
  /**
   ...
   */
  FreemarkerCoreToken *specialToken_;
}
...
+ (FreemarkerCoreToken *)newTokenWithInt:(jint)ofKind OBJC_METHOD_FAMILY_NONE;
...
J2OBJC_EMPTY_STATIC_INIT(FreemarkerCoreToken)

J2OBJC_FIELD_SETTER(FreemarkerCoreToken, image_, NSString *)
J2OBJC_FIELD_SETTER(FreemarkerCoreToken, next_, FreemarkerCoreToken *)
J2OBJC_FIELD_SETTER(FreemarkerCoreToken, specialToken_, FreemarkerCoreToken *)

FOUNDATION_EXPORT void FreemarkerCoreToken_init(FreemarkerCoreToken *self);

FOUNDATION_EXPORT FreemarkerCoreToken *new_FreemarkerCoreToken_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT void FreemarkerCoreToken_initWithInt_(FreemarkerCoreToken *self, jint kind);

FOUNDATION_EXPORT FreemarkerCoreToken *new_FreemarkerCoreToken_initWithInt_(jint kind) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT void FreemarkerCoreToken_initWithInt_withNSString_(FreemarkerCoreToken *self, jint kind, NSString *image);

FOUNDATION_EXPORT FreemarkerCoreToken *new_FreemarkerCoreToken_initWithInt_withNSString_(jint kind, NSString *image) NS_RETURNS_RETAINED;

FOUNDATION_EXPORT FreemarkerCoreToken *FreemarkerCoreToken_newTokenWithInt_withNSString_(jint ofKind, NSString *image);

FOUNDATION_EXPORT FreemarkerCoreToken *FreemarkerCoreToken_newTokenWithInt_(jint ofKind);

J2OBJC_TYPE_LITERAL_HEADER(FreemarkerCoreToken)

#endif // _FreemarkerCoreToken_H_
