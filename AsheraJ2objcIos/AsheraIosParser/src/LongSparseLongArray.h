...
/**
 @brief Creates a new SparseLongArray containing no mappings that will not require any additional memory allocation to store the specified number of mappings.
...
/**
 @brief Gets the long mapped from the specified key, or <code>0</code> if no such mapping has been made.
 */
- (jlong)getWithLong:(jlong)key;

/**
 @brief Gets the long mapped from the specified key, or the specified value if no such mapping has been made.
 */
- (jlong)getWithLong:(jlong)key
...
/**
 @brief Given an index in the range <code>0...size()-1</code>, returns the key from the <code>index</code>th key-value mapping that this SparseLongArray stores.
...
/**
 @brief Given an index in the range <code>0...size()-1</code>, returns the value from the <code>index</code>th key-value mapping that this SparseLongArray stores.
...
J2OBJC_EMPTY_STATIC_INIT(RepackagedAndroidUtilLongSparseLongArray)

FOUNDATION_EXPORT void RepackagedAndroidUtilLongSparseLongArray_init(RepackagedAndroidUtilLongSparseLongArray *self);

FOUNDATION_EXPORT RepackagedAndroidUtilLongSparseLongArray *new_RepackagedAndroidUtilLongSparseLongArray_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT void RepackagedAndroidUtilLongSparseLongArray_initWithInt_(RepackagedAndroidUtilLongSparseLongArray *self, jint initialCapacity);

FOUNDATION_EXPORT RepackagedAndroidUtilLongSparseLongArray *new_RepackagedAndroidUtilLongSparseLongArray_initWithInt_(jint initialCapacity) NS_RETURNS_RETAINED;

J2OBJC_TYPE_LITERAL_HEADER(RepackagedAndroidUtilLongSparseLongArray)

#endif // _RepackagedAndroidUtilLongSparseLongArray_H_
