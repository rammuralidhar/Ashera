...
#ifndef _RepackagedAndroidUtilSparseLongArray_H_
#define _RepackagedAndroidUtilSparseLongArray_H_
 ...
 */
@interface RepackagedAndroidUtilSparseLongArray : NSObject < NSCopying >
...
J2OBJC_EMPTY_STATIC_INIT(RepackagedAndroidUtilSparseLongArray)

FOUNDATION_EXPORT void RepackagedAndroidUtilSparseLongArray_init(RepackagedAndroidUtilSparseLongArray *self);

FOUNDATION_EXPORT RepackagedAndroidUtilSparseLongArray *new_RepackagedAndroidUtilSparseLongArray_init() NS_RETURNS_RETAINED;

FOUNDATION_EXPORT void RepackagedAndroidUtilSparseLongArray_initWithInt_(RepackagedAndroidUtilSparseLongArray *self, jint initialCapacity);

FOUNDATION_EXPORT RepackagedAndroidUtilSparseLongArray *new_RepackagedAndroidUtilSparseLongArray_initWithInt_(jint initialCapacity) NS_RETURNS_RETAINED;

J2OBJC_TYPE_LITERAL_HEADER(RepackagedAndroidUtilSparseLongArray)

#endif // _RepackagedAndroidUtilSparseLongArray_H_
