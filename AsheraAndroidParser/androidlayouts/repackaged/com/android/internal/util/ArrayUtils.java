...
package repackaged.com.android.internal.util;
...
import repackaged.android.util.ArraySet;
import repackaged.libcore.util.EmptyArray;
...
public class ArrayUtils {
    ...
    public static byte[] newUnpaddedByteArray(int minLen) {
        return  null;//(byte[])VMRuntime.getRuntime().newUnpaddedArray(byte.class, minLen);
    }

    public static char[] newUnpaddedCharArray(int minLen) {
    	return  null;// (char[])VMRuntime.getRuntime().newUnpaddedArray(char.class, minLen);
    }

    public static int[] newUnpaddedIntArray(int minLen) {
    	return  null;// (int[])VMRuntime.getRuntime().newUnpaddedArray(int.class, minLen);
    }

    public static boolean[] newUnpaddedBooleanArray(int minLen) {
    	return  new boolean[minLen];// (boolean[])VMRuntime.getRuntime().newUnpaddedArray(boolean.class, minLen);
    }

    public static long[] newUnpaddedLongArray(int minLen) {
    	return  new long[minLen];// (long[])VMRuntime.getRuntime().newUnpaddedArray(long.class, minLen);
    }

    public static float[] newUnpaddedFloatArray(int minLen) {
    	return  new float[minLen];// (float[])VMRuntime.getRuntime().newUnpaddedArray(float.class, minLen);
    }
    ...
    public static <T> T[] newUnpaddedArray(Class<T> clazz, int minLen) {
    	return  null;// (T[])VMRuntime.getRuntime().newUnpaddedArray(clazz, minLen);
    }
