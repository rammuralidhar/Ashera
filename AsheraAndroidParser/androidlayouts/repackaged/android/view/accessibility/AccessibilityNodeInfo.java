...
import repackaged.android.text.InputType;
...
public class AccessibilityNodeInfo implements Parcelable {
     ...
     *
     * @see #setTraversalBefore(repackaged.android.view.View)
     * @see #setTraversalBefore(repackaged.android.view.View, int)
     */
     ...
     * @return The succeeding node if such or <code>null</code>.
     *
     * @see #setTraversalAfter(repackaged.android.view.View)
     * @see #setTraversalAfter(repackaged.android.view.View, int)
     */
     ...
     *         live region.
     * @see repackaged.android.view.View#getAccessibilityLiveRegion()
     */
     ...
     *        {@link View#ACCESSIBILITY_LIVE_REGION_NONE} if the view is not a
     *        live region.
     * @see repackaged.android.view.View#setAccessibilityLiveRegion(int)
     */
    ...
    /**
     * @see repackaged.android.os.Parcelable.Creator
     */
