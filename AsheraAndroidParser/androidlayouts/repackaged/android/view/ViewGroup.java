...
import repackaged.android.animation.LayoutTransition;
...
import repackaged.android.util.SparseBooleanArray;
...
import repackaged.android.view.animation.LayoutAnimationController;
...
import static repackaged.android.os.Build.VERSION_CODES.JELLY_BEAN_MR1;
 ...
 * {@link repackaged.android.view.ViewGroup.LayoutParams} class which serves as the base
 ...
 * a simple {@link repackaged.android.widget.FrameLayout} along with the ability to stack
...
public abstract class ViewGroup extends View implements ViewParent, ViewManager {
     ...
     * {@link #getChildStaticTransformation(View, repackaged.android.view.animation.Transformation)} to be
     * invoked when a child is drawn.
     *
     * Any subclass overriding
     * {@link #getChildStaticTransformation(View, repackaged.android.view.animation.Transformation)} should
     ...
     * without a type.
     *
     * @see #startActionModeForChild(View, repackaged.android.view.ActionMode.Callback)
     * @see #startActionModeForChild(View, repackaged.android.view.ActionMode.Callback, int)
     */
     ...
     * {@link #requestFocus(int, repackaged.android.graphics.Rect)}.
     *
     ...
     * take focus in {@link #requestFocus(int, repackaged.android.graphics.Rect)}.
     *
     ...
     * <p>
     * If an {@link repackaged.android.view.View.AccessibilityDelegate} has been specified via calling
     * {@link repackaged.android.view.View#setAccessibilityDelegate(repackaged.android.view.View.AccessibilityDelegate)} its
     * {@link repackaged.android.view.View.AccessibilityDelegate#onRequestSendAccessibilityEvent(ViewGroup, View, AccessibilityEvent)}
     ...
     * non-null {@link repackaged.android.view.ViewOutlineProvider} other than
     * {@link repackaged.android.view.ViewOutlineProvider#BACKGROUND} was given to
     ...
     *
     * Uses {@link #onRequestFocusInDescendants(int, repackaged.android.graphics.Rect)} to
     * find focus within the children of this group when appropriate.
     *
     * @see #FOCUS_BEFORE_DESCENDANTS
     * @see #FOCUS_AFTER_DESCENDANTS
     * @see #FOCUS_BLOCK_DESCENDANTS
     * @see #onRequestFocusInDescendants(int, repackaged.android.graphics.Rect) 
     */
    @Override
     ...
     * Called by {@link ViewGroup#requestFocus(int, repackaged.android.graphics.Rect)}
     ...
     *               {@link repackaged.android.view.accessibility.AccessibilityNodeInfo}
    ...
    /**
     * Perform dispatching of a {@link #saveHierarchyState(repackaged.android.util.SparseArray)}  freeze()}
     * to only this view, not to its children.  For use when overriding
     * {@link #dispatchSaveInstanceState(repackaged.android.util.SparseArray)}  dispatchFreeze()} to allow
    ...
    /**
     * Perform dispatching of a {@link #restoreHierarchyState(repackaged.android.util.SparseArray)}
     * to only this view, not to its children.  For use when overriding
     * {@link #dispatchRestoreInstanceState(repackaged.android.util.SparseArray)} to allow
     ...
     *
     * @see #getChildStaticTransformation(View, repackaged.android.view.animation.Transformation)
     */
     ...
     * {@link #draw(repackaged.android.graphics.Canvas)}, {@link #onDraw(repackaged.android.graphics.Canvas)},
     * {@link #dispatchDraw(repackaged.android.graphics.Canvas)} or any related method.</p>
     *
     ...
     *
     * @see #attachViewToParent(View, int, repackaged.android.view.ViewGroup.LayoutParams)
     ...
     * either by a call to
     * {@link #attachViewToParent(View, int, repackaged.android.view.ViewGroup.LayoutParams)}
     ...
     * {@inheritDoc}
     */
    public boolean getChildVisibleRect(View child, Rect r, repackaged.android.graphics.Point offset) {
     ...
     *
     * @deprecated As of {@link repackaged.android.os.Build.VERSION_CODES#M}, this property is ignored.
     ...
     *
     * @return an instance of {@link repackaged.android.view.ViewGroup.LayoutParams} or one
     *         of its descendants
     */
     ...
     * {@link #checkLayoutParams(repackaged.android.view.ViewGroup.LayoutParams)}, this method
     ...
     * {@link android.app.Fragment} and {@link repackaged.android.animation.LayoutTransition} to animate
     ...
     * sent.
     *
     * @return an {@link repackaged.android.view.animation.Animation.AnimationListener}
     */
     ...
     * be sent. Only
     * {@link repackaged.android.view.animation.Animation.AnimationListener#onAnimationStart(Animation)}
     * and
     * {@link repackaged.android.view.animation.Animation.AnimationListener#onAnimationEnd(Animation)}
     * are invoked.
     *
    ...
    public static class MarginLayoutParams extends ViewGroup.LayoutParams {
        ...
        public MarginLayoutParams(Context c, AttributeSet attrs) {
            ...
            int margin = a.getDimensionPixelSize(
                    repackaged.com.android.internal.R.styleable.ViewGroup_MarginLayout_layout_margin, -1);
            if (margin >= 0) {
                leftMargin = margin;
                topMargin = margin;
                rightMargin= margin;
        ...
        /**
         * Sets the margins, in pixels. A call to {@link repackaged.android.view.View#requestLayout()} needs
         * to be done so that the new margins are taken into account. Left and right margins may be
         * overriden by {@link repackaged.android.view.View#requestLayout()} depending on layout direction.
        ...
        /**
         * Sets the relative margins, in pixels. A call to {@link repackaged.android.view.View#requestLayout()}
         * needs to be done so that the new relative margins are taken into account. Left and right
         * margins may be overriden by {@link repackaged.android.view.View#requestLayout()} depending on layout
        ...
        /**
         * This will be called by {@link repackaged.android.view.View#requestLayout()}. Left and Right margins
