...
public interface Build {
	...
	public class VERSION_CODES {
         ...
         * component.
         * <li> {@link repackaged.android.content.Context#getSharedPreferences
         * Context.getSharedPreferences()} will not automatically reload
         * the preferences if they have changed on storage, unless
         * {@link repackaged.android.content.Context#MODE_MULTI_PROCESS} is used.
         * <li> {@link repackaged.android.view.ViewGroup#setMotionEventSplittingEnabled}
         ...
         * will use {@link repackaged.android.view.View#setActivated View.setActivated}
         * for selected items if they do not implement {@link repackaged.android.widget.Checkable}.
         ...
         * {@link repackaged.android.content.res.Configuration#screenWidthDp},
         * {@link repackaged.android.content.res.Configuration#screenHeightDp}, and
         * {@link repackaged.android.content.res.Configuration#smallestScreenWidthDp}.
         * Supplying these in &lt;supports-screens&gt; as per
         * {@link repackaged.android.content.pm.ApplicationInfo#requiresSmallestWidthDp},
         * {@link repackaged.android.content.pm.ApplicationInfo#compatibleWidthLimitDp}, and
         * {@link repackaged.android.content.pm.ApplicationInfo#largestWidthLimitDp} is
         ...
         * new changes in behavior:</p>
         * <ul>
         * <li><p>New {@link repackaged.android.content.pm.PackageManager#FEATURE_SCREEN_PORTRAIT}
         * and {@link repackaged.android.content.pm.PackageManager#FEATURE_SCREEN_LANDSCAPE}
         ...
         * <li> {@link repackaged.android.content.Context#bindService Context.bindService()}
         * will not automatically add in {@link repackaged.android.content.Context#BIND_WAIVE_PRIORITY}.
         ...
         * <li> {@link repackaged.android.widget.RemoteViews} will throw an exception if
         ...
         * <li> Calls to {@link repackaged.android.content.pm.PackageManager#setComponentEnabledSetting
         ...
         * <li> {@link repackaged.android.accessibilityservice.AccessibilityServiceInfo#FLAG_INCLUDE_NOT_IMPORTANT_VIEWS
         ...
         * <li>{@link repackaged.android.view.View#getLayoutDirection() View.getLayoutDirection()}
         * can return different values than {@link repackaged.android.view.View#LAYOUT_DIRECTION_LTR}
         ...
         * <li> {@link repackaged.android.content.Context#getSharedPreferences(String, int)
         * Context.getSharedPreferences} no longer allows a null name.</li>
         * <li> {@link repackaged.android.widget.RelativeLayout} changes to compute wrapped content
