 ...
 * {@link repackaged.android.widget.LinearLayout.LayoutParams LinearLayout.LayoutParams}.
...
public class LinearLayout extends ViewGroup {
    ...
    public LinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final TypedArray a = context.obtainStyledAttributes(
                attrs, repackaged.com.android.internal.R.styleable.LinearLayout, defStyleAttr, defStyleRes);

        int index = a.getInt(repackaged.com.android.internal.R.styleable.LinearLayout_orientation, -1);
        if (index >= 0) {
            setOrientation(index);
        }

        index = a.getInt(repackaged.com.android.internal.R.styleable.LinearLayout_gravity, -1);
        if (index >= 0) {
            setGravity(index);
        }
        ...
        mBaselineAlignedChildIndex =
                a.getInt(repackaged.com.android.internal.R.styleable.LinearLayout_baselineAlignedChildIndex, -1);
    ...
    private void setChildFrame(View child, int left, int top, int width, int height) {        
        ...
        System.out.println(child.getId() + " " + left + " " + top + " " + width + " " + height);
    }
     ...
     * {@link repackaged.android.view.ViewGroup.LayoutParams#MATCH_PARENT}
     * and a height of {@link repackaged.android.view.ViewGroup.LayoutParams#WRAP_CONTENT}
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a =
                    c.obtainStyledAttributes(attrs, repackaged.com.android.internal.R.styleable.LinearLayout_Layout);

            weight = a.getFloat(repackaged.com.android.internal.R.styleable.LinearLayout_Layout_layout_weight, 0);
            gravity = a.getInt(repackaged.com.android.internal.R.styleable.LinearLayout_Layout_layout_gravity, -1);
