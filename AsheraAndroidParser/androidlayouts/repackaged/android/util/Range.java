...
import static repackaged.com.android.internal.util.Preconditions.*;
import repackaged.android.hardware.camera2.utils.HashCodeHelpers;
...
public final class Range<T extends Comparable<? super T>> {
    ...
    @Override
    public int hashCode() {
        return 0;// HashCodeHelpers.hashCodeGeneric(mLower, mUpper);
    }
