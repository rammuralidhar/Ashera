...
package repackaged.android.util;

import repackaged.com.android.internal.R;

/**
 * State sets are arrays of positive ints where each element
 * represents the state of a {@link repackaged.android.view.View} (e.g. focused,
 * selected, visible, etc.).  A {@link repackaged.android.view.View} may be in
 ...
 * {@link repackaged.android.view.View} state.
 *
...
public class StateSet {
     ...
     * {@link repackaged.android.view.View#getDrawableState()}
     */
     ...
     *        prohibited (if negative) {@link repackaged.android.view.View} states.
     * @param stateSet an array of {@link repackaged.android.view.View} states
     */
     ...
     * @param stateSpec an array of required (if positive) or
     *        prohibited (if negative) {@link repackaged.android.view.View} states.
     * @param state a {@link repackaged.android.view.View} state
     */
